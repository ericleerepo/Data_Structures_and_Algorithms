...
private:
   ...
   // Dictionary fields
   Node* nil; //considered the leaves of the tree of key-bearing nodes
   Node* root;
   Node* current;
   int   num_pairs;
   ...
   // Dictionary. Recursion terminates at N. #copying from subtree from R into this tree
   ...
   // the address of the Node if it exists, returns nil otherwise. #for hasCurrent, contains
...
public:
   ...
   // Copy constructor. //use pre-order tree walk
   Dictionary(const Dictionary& D);

   // Destructor #call clear, free nil node, return
   ~Dictionary();
   ...
   // pairs as Dictionary D. Does not require same tree structure.
